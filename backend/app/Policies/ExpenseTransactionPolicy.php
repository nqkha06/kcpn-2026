...
class ExpenseTransactionPolicy
{
    ...
    {
        return $user->hasRole('admin') || $user->id === $expenseTransaction->user_id;
    }
     ...
     */
    public function restore(User $user, ExpenseTransaction $expenseTransaction): bool
    {
        return $user->hasRole('admin') || $user->id === $expenseTransaction->user_id;
    }
     ...
     */
    public function forceDelete(User $user, ExpenseTransaction $expenseTransaction): bool
    {
        return $user->hasRole('admin') || $user->id === $expenseTransaction->user_id;
    }
}
